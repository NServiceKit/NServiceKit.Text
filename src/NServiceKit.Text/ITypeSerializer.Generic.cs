...
namespace NServiceKit.Text
{
	...
	public interface ITypeSerializer<T>
	{
        ...
        /// <returns>
        /// <c>true</c> if this instance [can create from string] the specified type; otherwise,
        /// <c>false</c>.
        /// </returns>
        ...
        /// <summary>Deserializes from reader.</summary>
        ...
        /// <summary>Serializes to writer.</summary>
        /// <param name="value"> The value.</param>
