...
namespace NServiceKit.Text.Tests
{
    ...
    public class StringTests
    {
        ...
        public void SerializerTests()
        {
            ...
            // serialize to JSON using NServiceKit
            ...
            var bclJsonString = JsonDataContractSerializer.Instance.SerializeToString(v);
        ...
        public void RoundTripTest()
        {
            ...
            var bclString = JsonDataContractDeserializer.Instance.DeserializeFromString<string>(json);
            var ssString = NServiceKit.Text.JsonSerializer.DeserializeFromString<string>(json);
            ...
            var ssJson = NServiceKit.Text.JsonSerializer.SerializeToString(ssString, typeof(string));
            //var bclJson = new System.Web.Script.Serialization.JavaScriptSerializer().Serialize(bclString);
            var bclJson = JsonDataContractSerializer.Instance.SerializeToString(bclString);
        ...
        public void Deserializes_string_with_quotes_correctly()
        {
            ...
            var json = JsonSerializer.SerializeToString(original);
            var bclJson = JsonDataContractSerializer.Instance.SerializeToString(original);
            Assert.That(json, Is.EqualTo(bclJson));

            var fromJson = JsonSerializer.DeserializeFromString<string>(json);
            var fromJsonBcl = JsonDataContractDeserializer.Instance.DeserializeFromString<string>(json);
